...
################################################################################################################################################################
# ochuman_connMat = np.array([[24, 25], [24, 26], [25, 27], [26, 28], [4, 7], [5, 8], [4, 46], [5, 45], [16, 18], [18, 20], [17, 19], [19, 21]])
# cm_ochuman = np.array([[255,0,85],[255,0,85],[255,0,85],[255,0,85], [255,0,0],[255,85,0],[255,0,0],[255,85,0], [255,255,0],[170,255,0],[255,255,0],[170,255,0]])
# ochuman_connMat = np.array([[16, 19], [13, 17], [4, 5],
#                          [19, 17], [17, 14], [5, 6],
#                          [17, 18], [14, 4], [1, 2],
#                          [18, 15], [14, 1], [2, 3],
#                          [4, 10], [1, 7], [10, 7],
#                          [10, 11], [7, 8], [11, 12], [8, 9],
#                          [16, 4], [15, 1]])-1
# ochuman_connMat = np.array([[15, 18], [18, 16], [16, 17], [17, 14],
#                             [12, 13],
#                             [13, 0], [0, 1], [1, 2],
#                             [13, 3], [3, 4], [4, 5],
#                             [6, 7], [7, 8],
...
# crowdpose_connMat = np.array([[0, 2], [2, 4], [1, 3], [3, 5],
#                                 [6, 8], [8, 10], [7, 9], [9, 11],
#                                 [12, 13]])
