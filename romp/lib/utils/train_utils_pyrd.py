...
def determine_rendering_order(rendered_img, thresh=0.):
    ...
    main_renders = rendered_img
    #print("#"*10, rendered_img.shape)
    ...
    main_renders_ = main_renders.copy()
    main_renders_[other_render_mask] = other_renders[other_render_mask]

    # return main_renders[None]
    return main_renders_[None]
